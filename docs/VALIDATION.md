...
A later version changed the empirical LiHV energy adjustment. The
zero-difference battery comparison below applies only to the two source
versions identified here, not every subsequent version.
Version `0.1.2rc1` also corrects Kirschstein's rotor-area term; the historical
zero-difference results below do not describe that corrected implementation.
...
- Original range calculator, source SHA-256
  `6f9f027ab34fdec33c8369d4fe45e99b77e715f3bff70ff183f7fd984eb848b2`.
- Public calculator, entry point `multicopter_range.py`, source SHA-256
  `65ded35f3a68943b9a8ed69a68f9451e33ceff265f73c6d8a8f1cfc44952d296`.
